  ...
  <footer style={{ background: "#1f261d", color: "#c8d9b8" }}>
    ...
    <div className="container grid gap-8 py-12 md:grid-cols-6">
      ...
      <div className="space-y-4 md:col-span-1">
        <img src="/logo-dark.svg" alt="Renovapack" className="h-8 w-auto object-contain" />
        <p className="text-[12px] leading-relaxed" style={{ color: "#8aab7a" }}>
          El futuro se empaca distinto. Pioneros en empaque desechable y biodegradable para HORECA y B2B en México.
        </p>
